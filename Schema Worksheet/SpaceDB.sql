...
REM StarDisc.solar_system table has a foreign key to this table.
REM Planet.solar_system table has a foreign key to this table.
REM Revolves.solar_system table has a foreign key to this table.
...
REM Revoles.planet_name table has a foreign key to this table.
REM PlanetDisc.planet_name table has a foreign key to this table.
REM Center.planet_name table has a foreign key to this table.

CREATE TABLE planet
    ( name	VARCHAR2(25)
    , solar_system  VARCHAR2(25)
    , distance_from_center  NUMBER
REM SIZE MIGHT BE A KEYWORD --------------
    , size      NUMBER
